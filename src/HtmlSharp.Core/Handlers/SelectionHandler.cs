...
using HtmlSharp.Core.Adapters.Entities;
using HtmlSharp.Core.Dom;
using HtmlSharp.Core.Entities;
using HtmlSharp.Core.Utils;

namespace HtmlSharp.Core.Handlers
{
    /// <summary>
    ...
    internal sealed class SelectionHandler : IDisposable
    {
        ...
        /// <seealso cref="CalculateWordCharIndexAndOffset(HtmlSharp.Core.Adapters.RControl,HtmlSharp.Core.Dom.CssRect,HtmlSharp.Core.Adapters.Entities.RPoint,bool)"/>.
        /// </summary>
